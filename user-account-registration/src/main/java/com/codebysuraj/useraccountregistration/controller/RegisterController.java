...
//    public String processLoginForm(ModelAndView modelAndView, User user, HttpServletRequest request) {
...
//
//		if (userExists == null) {
//			modelAndView.addObject("notMessage", "Oops!  There is no any user registered with the email provided.");
//			modelAndView.setViewName("login");
//			bindingResult.reject("email");
//		}
//		if (bindingResult.hasErrors()) {
